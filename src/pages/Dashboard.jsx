  ...
  if (totalCourses === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <Link to="/courses/new">
          <button className="flex items-center justify-center gap-1 px-4 py-2 bg-blue-500 text-white rounded">
  ...
  return (
    <div className="flex flex-col gap-6 px-4 md:px-6 lg:px-8">
      <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="p-6 rounded-lg bg-gray-800 border border-gray-700 text-sm md:text-md">
          <h3 className="mb-4 text-lg font-semibold">Attendance Summary</h3>
          <div className="border-l-4 border-green-500 bg-green-900/20 p-3 mb-4">
      ...
      <div className="p-6 rounded-lg bg-gray-800 border border-gray-700 w-full md:w-[450px] mt-6">
